...
--	order_id_fk int references movies(movie_id) not null
	...
	insert into movies (title, genre, releaseYear) values('ambulance', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('the batman', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('the lost city', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('everything everywhere all at once', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('the contractor', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('the northman', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('doctor strange and the multiverse of madness', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('the roundup', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('top gun: maverick', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('jurassic world: dominion', 'action', 2022 );
    insert into movies (title, genre, releaseYear) values('operation fortune: ruse de guerre', 'action', 2022 );


    insert into movies (title, genre, releaseYear) values('uncharted', 'adventure', 2022 );
    insert into movies (title, genre, releaseYear) values('free guy', 'adventure', 2021 );
    insert into movies (title, genre, releaseYear) values('moonfall', 'adventure', 2022 );
     insert into movies (title, genre, releaseYear) values('dune', 'adventure', 2021 );
    insert into movies (title, genre, releaseYear) values('ghostbusters afterlife', 'adventure', 2021 );
    insert into movies (title, genre, releaseYear) values('spiderman no way home', 'adventure', 2021 );
    insert into movies (title, genre, releaseYear) values('morbius', 'adventure', 2022 );
    insert into movies (title, genre, releaseYear) values('no time to die', 'adventure', 2021 );
    insert into movies (title, genre, releaseYear) values('the secrets of dumbledore', 'adventure', 2022 );
    insert into movies (title, genre, releaseYear) values('the bad guys', 'adventure', 2022 );
    insert into movies (title, genre, releaseYear) values('eternals', 'adventure', 2021 );

    insert into movies (title, genre, releaseYear) values('jackass forever', 'comedy', 2022 );
    insert into movies (title, genre, releaseYear) values('marry me', 'comedy', 2021 );
    insert into movies (title, genre, releaseYear) values('i want you back', 'comedy', 2022 );
    insert into movies (title, genre, releaseYear) values('dog', 'comedy', 2021 );
    insert into movies (title, genre, releaseYear) values('turning red', 'comedy', 2021 );
    insert into movies (title, genre, releaseYear) values('the unbearable weight of massive talent', 'comedy', 2021 );
    insert into movies (title, genre, releaseYear) values('senior year', 'comedy', 2022 );
    insert into movies (title, genre, releaseYear) values('chip n dale: rescue rangers', 'comedy', 2021 );
    insert into movies (title, genre, releaseYear) values('a perfect pairing', 'comedy', 2022 );
    insert into movies (title, genre, releaseYear) values('cocaine bear', 'comedy', 2023 );
    insert into movies (title, genre, releaseYear) values('fire island', 'comedy', 2021 );

    insert into movies (title, genre, releaseYear) values('luckiest girl alive', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('amsterdam', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('knock at the cabin', 'drama', 2023 );
    insert into movies (title, genre, releaseYear) values('blonde', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('grimcutty', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('the woman king', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('triangle of sadness', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('the banshees of inisherin', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('significant other', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('the greatest beer run ever', 'drama', 2022 );
    insert into movies (title, genre, releaseYear) values('where the crawdads sing', 'drama', 2021 );

    insert into movies (title, genre, releaseYear) values('halloween ends', 'horror', 2022 );
    insert into movies (title, genre, releaseYear) values('x', 'horror', 2022 );
    insert into movies (title, genre, releaseYear) values('watcher', 'horror', 2022 );
    insert into movies (title, genre, releaseYear) values('midsommar', 'horror', 2019 );
    insert into movies (title, genre, releaseYear) values('dashcam', 'horror', 2021 );
    insert into movies (title, genre, releaseYear) values('hereditary', 'horror', 2018 );
    insert into movies (title, genre, releaseYear) values('halloween', 'horror', 2018 );
    insert into movies (title, genre, releaseYear) values('nope', 'horror', 2021 );
    insert into movies (title, genre, releaseYear) values('jeepers creepers reborn', 'horror', 2022 );
    insert into movies (title, genre, releaseYear) values('hellraiser', 'horror', 2022 );
    insert into movies (title, genre, releaseYear) values('doctor sleep', 'horror', 2019 );

    insert into movies (title, genre, releaseYear) values('a star is born', 'romance', 2018 );
    insert into movies (title, genre, releaseYear) values('call me by your name', 'romance', 2017 );
    insert into movies (title, genre, releaseYear) values('bros', 'romance', 2022 );
    insert into movies (title, genre, releaseYear) values('the vow', 'romance', 2012 );
    insert into movies (title, genre, releaseYear) values('la la land', 'romance', 2016 );
    insert into movies (title, genre, releaseYear) values('crazy rich asians', 'romance', 2018 );
    insert into movies (title, genre, releaseYear) values('emma', 'romance', 2020 );
    insert into movies (title, genre, releaseYear) values('after', 'romance', 2022 );
    insert into movies (title, genre, releaseYear) values('her', 'romance', 2013 );
    insert into movies (title, genre, releaseYear) values('persuasion', 'romance', 2022 );
    insert into movies (title, genre, releaseYear) values('father of the bride', 'romance', 2022 );

    insert into movies (title, genre, releaseYear) values('interstellar', 'scifi', 2014 );
    insert into movies (title, genre, releaseYear) values('blade runner 2049', 'scifi', 2017 );
    insert into movies (title, genre, releaseYear) values('arrival', 'scifi', 2016 );
    insert into movies (title, genre, releaseYear) values('annihalation', 'scifi', 2016 );
    insert into movies (title, genre, releaseYear) values('spiderhead', 'scifi', 2022 );
    insert into movies (title, genre, releaseYear) values('life', 'scifi', 2017 );
    insert into movies (title, genre, releaseYear) values('prey', 'scifi', 2022 );
    insert into movies (title, genre, releaseYear) values('tenet', 'scifi', 2020 );
    insert into movies (title, genre, releaseYear) values('the invisible man', 'scifi', 2020 );
    insert into movies (title, genre, releaseYear) values('the blackout', 'scifi', 2019 );
    insert into movies (title, genre, releaseYear) values('ex machina', 'scifi', 2014 );

    insert into movies (title, genre, releaseYear) values('1917', 'war', 2019 );
    insert into movies (title, genre, releaseYear) values('operation mincemeat', 'war', 2021 );
    insert into movies (title, genre, releaseYear) values('midway', 'war', 2019 );
    insert into movies (title, genre, releaseYear) values('the king', 'war', 2019 );
    insert into movies (title, genre, releaseYear) values('dunkirk', 'war', 2017 );
    insert into movies (title, genre, releaseYear) values('hacksaw ridge', 'war', 2016 );
    insert into movies (title, genre, releaseYear) values('13 hours: the secret soldiers of benghazi', 'war', 2016 );
    insert into movies (title, genre, releaseYear) values('fury', 'war', 2014 );
    insert into movies (title, genre, releaseYear) values('war dogs', 'war', 2016 );
    insert into movies (title, genre, releaseYear) values('12 strong', 'war', 2018 );
    insert into movies (title, genre, releaseYear) values('a call to spy', 'war', 2019 );